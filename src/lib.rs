  ...
  C2: StepCircuit<G2::Scalar>,
{
  ...
  pub l_w_primary: RelaxedR1CSWitness<G1>,
  pub l_u_primary: RelaxedR1CSInstance<G1>,
  pub r_W_secondary: RelaxedR1CSWitness<G2>,
  pub r_U_secondary: RelaxedR1CSInstance<G2>,
  pub l_w_secondary: RelaxedR1CSWitness<G2>,
  pub l_u_secondary: RelaxedR1CSInstance<G2>,
  pub i: usize,
